$(function(){
    ...
    $('#boton2').click(function(e){
        ...
        if(locations.length > 2)
        {
            ...
            map.drawRoute({
                origin: [locations[0][0], locations[0][1]],  // origen del punto inicial
                destination: [locations[locations.length - 1][0], locations[locations.length - 1][1]],
                travelMode: 'driving',
        ...
        {
            alert("Solo podemos reducir una ruta con más de 2 puntos");
        }
